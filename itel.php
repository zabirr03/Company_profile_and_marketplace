...
<body>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink1">
                            ...
                            <a class="dropdown-item disabled" href="<?= $WEB_CONFIG['base_url'] ?>itel.php">
                                Itel Mobile
                            </a>
    ...
    <div class="container-fluid text-left" style="margin-top: 40px; margin-left: 20px; justify-content: center;">
        ...
        <br/>
        <br/>
        <h2 class="font-weight-bold">Produk Unggulan Itel :</h2>
        <br/>
        <br/>
        <br/>
    </div>
    <div class="container text-center">
        <div class="row">
            <?php
               ...
               $sql = "SELECT * FROM tb_produk WHERE pr_vendor = 'itel'";
