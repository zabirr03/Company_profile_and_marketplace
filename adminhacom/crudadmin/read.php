...
<a href="<?= $WEB_CONFIG['base_url'] ?>adminhacom/crudadmin/index.php?page=add" class="btn btn-primary mb-3">
...
<div class="box_table">
    <table class="table-responsive table-sm" style="height: 450px;">
        ...
        <tbody>
            ...
            $sql = "SELECT * FROM tb_admin ORDER BY adm_id DESC";
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="<?= $WEB_CONFIG['base_url'] ?>adminhacom/crudadmin/index.php?page=update&adm_id=<?= $row['adm_id'] ?>" class="btn btn-success btn-sm">
                    ...
                    <a href="javascript:alertDelete(<?= $row['adm_id'] ?>);" class="btn btn-danger btn-sm">
                    <svg style="width:15px;height:15px" viewBox="0 0 24 24" class="mb-1">
...
function alertDelete(idn) {
    ...
    $('#deleteButtonModal').attr('href', '<?= $WEB_CONFIG['base_url'] ?>adminhacom/crudadmin/index.php?page=delete&adm_id='+idn);
